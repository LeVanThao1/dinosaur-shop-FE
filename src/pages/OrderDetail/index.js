...
function OrderDetail(props) {
  ...
  useEffect(() => {
    if (!currentOrder) {
      ...
      API("api/orders/" + id, "GET", token).then(res => {
                ...
                <div className="status_order-content">
                  ...
                  <div className="status_order-content--detail">
                    <div className="status_order-content--description">
                      <span>
                        Vào lúc{" "}
                        {moment(currentOrder.createAt).format(
                          "hh:mm"
                        )}
												-{" "}
                        {moment(currentOrder.createAt).format(
                    ...
                    <div className="status_order-content--description">
                      <span>
                        Vào lúc{" "}
                        {moment(currentOrder.updatedAt).format(
                          "hh:mm"
                        )}
												-{" "}
                        {moment(currentOrder.updatedAt).format(
                    ...
                    <div className="status_order-content--description">
                      <span>
                        Vào lúc{" "}
                        {moment(currentOrder.dateOrder).format(
                          "hh:mm"
                        )}
												-{" "}
                        {moment(currentOrder.dateOrder).format(
              ...
              <div className="detail_order">
                <div className="detail_order-box">
                  ...
                  <div className="detail_order-box-decription">
                    <span>Họ tên: {currentOrder.user.name}</span>
                    <span>
                      Điện thoại: {currentOrder.user.phone}
                    </span>
                    <span>Email: {currentOrder.user.email}</span>
                    <span>
                      Địa chỉ: {currentOrder.user.address}
                    </span>
                    <span>
                      Quận/Huyện: {currentOrder.user.district}
                    </span>
                    <span>
                      Thành phố/Tỉnh:{" "}
