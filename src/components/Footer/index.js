			...
			<div className="footer_desktop">
				...
				<div className="infor_shop">
					<div className="category">
						<p className="title">{t("homepage.product")}</p>
						<ul>
							<li>{t("homepage.menShoes")}</li>
							<li>{t("homepage.womenShoes")}</li>
							<li>{t("homepage.fashionAccessories")}</li>
							<li>Sale-off</li>
						</ul>
					</div>
					<div className="company">
						<p className="title">{t("homepage.aboutCompany")}</p>
						<ul>
							<li>{t("homepage.recruitmentDinosaur")}</li>
							<li>{t("homepage.contactFranchise")}</li>
							<li>{t("homepage.aboutDinosaur")}</li>
						</ul>
					</div>
					<div className="suport">
						<p className="title">{t("homepage.support")}</p>
						<ul>
							<li>FAQs</li>
							<li>{t("homepage.informationSecurity")}</li>
							<li>{t("homepage.generalPolicy")}</li>
							<li>{t("homepage.lookupOrder")}</li>
						</ul>
					</div>
					<div className="contact">
						<p className="title">{t("homepage.contact")}</p>
						<ul>
							<li>{t("homepage.contributionEmail")}</li>
							<li>Hotline</li>
							<li>0348120116</li>
						</ul>
					</div>
					<div className="social">
						<p className="title">{t("homepage.social")}</p>
						<div className="icons">
